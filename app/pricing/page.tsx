  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
      <div className="max-w-md w-full">
        ...
        <p className="text-gray-500 text-center mb-10">Start growing your real estate business</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg border-2 border-blue-500 p-8">
          ...
          <p className="text-gray-500 mb-6">Everything you need to close more deals</p>
